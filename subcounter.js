...
function request_data(channel_id)
{
	...
	xhttp.onreadystatechange = function()
	{
		if (this.readyState == 4 && this.status == 200)
		{
			...
			document.getElementById("sub_count").innerHTML = output.items[0].statistics["subscriberCount"]+[" subs"]
		}
	...
	xhttp.open("GET", "https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id="+channel_id+"&key=AIzaSyAKkX_zxu6rksdjmUrJGejj_q51CybuRQ0", true);
	xhttp.send();
